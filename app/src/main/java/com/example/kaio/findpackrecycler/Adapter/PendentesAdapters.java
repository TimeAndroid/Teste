...
import com.example.kaio.findpackrecycler.Activitys.PendentesActivity;
import com.example.kaio.findpackrecycler.Model.ResponseCorreios;
import com.example.kaio.findpackrecycler.R;

import java.util.List;

public class PendentesAdapters extends RecyclerView.Adapter<PendentesAdapters.MyViewHolder> {
